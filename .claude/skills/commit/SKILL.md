---
name: commit
description: Create well-structured git commits following Conventional Commits style. Use when the user asks to commit changes, stage files, or create a git commit.
---
